// Package is31fl3731 provides Go driver for the Lumissil IS31FL3731
// matrix LED driver.
//
// Driver can be used with TinyGo: https://github.com/tinygo-org/tinygo
//
...
func New(bus I2C, address uint8) (d Device, err error) {
	d = Device{
		Address: address,
		bus:     bus,
		board:   boardRaw,
...
func NewAdafruitCharlieWing15x7(bus I2C, address uint8) (d Device, err error) {
	d = Device{
		Address: address,
		bus:     bus,
